...
<?php
echo form_open('items/save1/'.$item_info->item_id,array('id'=>'item_form', 'enctype'=>'multipart/form-data'));
?>
...
<?php echo form_label($this->lang->line('items_reorder_level').':', 'reorder_level',array('class'=>'required wide')); ?>
	...
	<?php echo form_input(array(
		...
		'id'=>'reorder_level',
		'size'=>'8',
		'value'=>isset($item_info->reorder)?$item_info->reorder:0)
	);?>
	</div>
	</div>

        <div class="field_row clearfix">
<?php echo form_label($this->lang->line('recvs_item_vehicle_no').':', 'vehicle_no',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'vehicle_no',
		'id'=>'vehicle_no',
		'size'=>'8',
		'value'=>isset($item_info->vehicle_no)?$item_info->vehicle_no:0)
	);?>
	</div>
	</div><div class="field_row clearfix">
<?php echo form_label($this->lang->line('recvs_item_driver_no').':', 'driver_no',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'driver_no',
		'id'=>'driver_no',
		'size'=>'8',
		'value'=>isset($item_info->driver_no)?$item_info->driver_no:0)
	);?>
	</div>
	</div><div class="field_row clearfix">
<?php echo form_label($this->lang->line('recvs_vendor').':', 'vendor',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'vendor',
		'id'=>'vendor',
		'size'=>'8',
		'value'=>isset($item_info->vendor)?$item_info->vendor:0)
	);?>
	</div>
	</div><div class="field_row clearfix">
<?php echo form_label($this->lang->line('recvs_scrap').':', 'scrap',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'scrap',
		'id'=>'scrap',
		'size'=>'8',
		'value'=>isset($item_info->scrap)?$item_info->scrap:0)
	);?>
	</div>
	</div>
...
<?php echo form_label($this->lang->line('items_is_serialized').':', 'is_serialized',array('class'=>'wide')); ?>
	...
	<?php echo form_checkbox(array(
		...
		'id'=>'is_serialized',
		'value'=>1,
		'checked'=>isset($item_info->serialized)? 1 : 0)
	);?>
	</div>
</div>
...
<?php echo form_label($this->lang->line('items_is_deleted').':', 'is_deleted',array('class'=>'wide')); ?>
	...
	<?php echo form_checkbox(array(
		...
		'id'=>'is_deleted',
		'value'=>1,
		'checked'=>(isset($item_info->deleted))? 1 : 0)
	);?>
	</div>
</div>
<!-- Parq End -->
